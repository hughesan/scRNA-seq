...
```{r}
load('plots_5dpf_Raj/slc6a1b-plots-clusterfraction-2021-8-5.RData')
...
ggplot(dec_ast_mnn_df, aes(x=mean, y=total, label=rownames(decardf)))+
  #geom_point(shape=21)+
  geom_text(check_overlap = TRUE)+
  geom_smooth(color="magenta")+
  labs(x = "Mean log-expression", y = "Variance")+
...
```{r}
save.image('plots_5dpf_Raj/slc6a1b-plots-clusterfraction-2021-8-11.RData')
```
